...
/* ── Glass input ───────────────────────────────────────────── */
function GlassInput({ label, type, placeholder, value, onChange, autoComplete, rightSlot, autoFocus }) {
  return (
    ...
    <div style={{ textAlign: "center" }}>
      <div style={{ marginBottom: "3rem" }}>
        <div style={{
          ...
          <img src={LOGO_IMAGE} alt="Gadvede Trekkers" style={{ width: "100%", objectFit: "contain" }} />
        </div>
  ...
  return (
    <div style={{
      ...
      <h2 style={{
        ...
        margin: "0 0 1.75rem", letterSpacing: "-0.02em",
      }}>
        Sign in
      </h2>
        ...
        <button
          ...
          style={{
            ...
            background: loading || !form.username || !form.password
              ? "rgba(224,242,241,0.35)" : "#e0f2f1",
            color: loading || !form.username || !form.password
              ? "rgba(10,20,18,0.4)" : "#0a140e",
      ...
      <p style={{
        textAlign: "center", margin: "1.75rem 0 0",
        ...
        <a href="/" style={{ color: "rgba(255,255,255,0.28)", textDecoration: "none", fontSize: "0.82rem" }}>
          ← Website
        </a>
      </p>
    </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 420 }}>
        <div style={{ position: "relative" }}>
          <div style={{
            ...
            transform: view === "splash" ? "translateX(0)" : "translateX(40px)",
            pointerEvents: view === "splash" ? "auto" : "none",
            position: view === "splash" ? "relative" : "absolute",
            width: "100%",
          }}>
          ...
          <div style={{
            transition: "opacity 0.3s, transform 0.3s",
            opacity: view === "signin" ? 1 : 0,
            transform: view === "signin" ? "translateX(0)" : "translateX(40px)",
            pointerEvents: view === "signin" ? "auto" : "none",
            position: view === "signin" ? "relative" : "absolute",
            width: "100%",
          }}>
      ...
      <p style={{
        ...
        Gadvede Trekkers — Admin Panel
      </p>

      <style>{`
        input::placeholder { color: rgba(255,255,255,0.22); }
        input:-webkit-autofill {
          -webkit-box-shadow: 0 0 0 1000px rgba(8,14,20,0.95) inset !important;
